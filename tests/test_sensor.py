...
async def test_monitor_status_sensor_exists(hass: HomeAssistant, single_server_config) -> None:
...
async def test_monitor_status_sensor_value(hass: HomeAssistant, single_server_config) -> None:
...
async def test_monitor_status_sensor_unavailable(hass: HomeAssistant, single_server_config) -> None:
...
async def test_event_sensor_unit_of_measurement(hass: HomeAssistant, single_server_config) -> None:
...
async def test_event_sensor_name_format(hass: HomeAssistant, single_server_config) -> None:
...
async def test_event_sensor_none_handling(hass: HomeAssistant, single_server_config) -> None:
...
async def test_run_state_sensor_exists(hass: HomeAssistant, single_server_config) -> None:
...
async def test_run_state_sensor_value(hass: HomeAssistant, single_server_config) -> None:
    """Test run state sensor shows state name."""
    monitors = [create_mock_monitor(name="Cam")]
    await _setup_zm_with_sensors(hass, single_server_config, monitors, active_state="Home")
...
async def test_platform_not_ready_empty_monitors(hass: HomeAssistant, single_server_config) -> None:
...
async def test_subset_condition_filtering(hass: HomeAssistant, single_server_config) -> None:
...
async def test_default_conditions_only_all(hass: HomeAssistant, single_server_config) -> None:
