...
async def test_valid_ssl_config(hass: HomeAssistant, mock_client_patch, ssl_config) -> None:
...
async def test_valid_no_auth_config(hass: HomeAssistant, mock_client_patch, no_auth_config) -> None:
