...
async def test_binary_sensor_created_per_server(hass: HomeAssistant, single_server_config) -> None:
...
async def test_binary_sensor_name_from_hostname(hass: HomeAssistant, single_server_config) -> None:
